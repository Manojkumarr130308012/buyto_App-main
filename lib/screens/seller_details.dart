...
class _SellerDetailsState extends State<SellerDetails> {
  ...
  fetchAllProductData() async {
    ...
    print("_allProductList${_allProductList}");
            ...
            child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  return Container(
                    ...
                    margin: _featuredProducts![index].margin,
                    // mrp: _featuredProducts![index].mrp,
                    // moq: _featuredProducts[index].moq,
                    // unit_name: _featuredProducts![index].unit_name,
                    // brand_name: _featuredProducts![index].new_brand_name,
                    // category_name: _featuredProducts![index].new_category_name,
                  );
                },
    ...
    return MasonryGridView.count(
        ...
        itemBuilder: (context, index) {
          return ProductCard(
            ...
            gender: _topProducts![index].gender,
          );
        });
  }
      ...
      return MasonryGridView.count(
          ...
          itemBuilder: (context, index) {
            return ProductCard(
              ...
              margin: _newArrivalProducts![index].margin,
              mrp: _newArrivalProducts![index].mrp,
              moq: _newArrivalProducts[index].moq,
              unit_name: _newArrivalProducts![index].unit_name,
              brand_name: _newArrivalProducts![index].new_brand_name,
              category_name: _newArrivalProducts![index].new_category_name,
              gender: _newArrivalProducts![index].gender,
            );
          });
    } else if (_newArrivalProducts.length == 0) {
      return Center(
    ...
    return AppBar(
      ...
      title: Container(
        child: Container(
            ...
            child:
                //false
                _shopDetails != null ? buildAppbarShopTitle() : null),
      ),
      elevation: 0.0,
      titleSpacing: 0,
      /* actions: <Widget>[
    ...
    return Row(mainAxisAlignment: MainAxisAlignment.start, children: <Widget>[
      Container(
        ...
        child: Text(
          ...
          maxLines: 1,
          style: TextStyle(
              color: MyTheme.white, fontSize: 16, fontWeight: FontWeight.w600),
        ),
      ),
    ]);
  }
    ...
    return MasonryGridView.count(
        ...
        itemBuilder: (context, index) {
          return ProductCard(
            ...
            margin: _allProductList![index].margin,
            mrp: _allProductList![index].mrp,
            moq: _allProductList[index].moq,
            unit_name: _allProductList![index].unit_name,
            brand_name: _allProductList![index].new_brand_name,
            category_name: _allProductList![index].new_category_name,
            gender: _allProductList![index].gender,
          );
        });
  }
}
