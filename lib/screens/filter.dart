...
class _FilterState extends State<Filter> {
  ...
  fetchProductData() async {
    ...
    var productResponse = await ProductRepository().getFilteredProducts(
        ...
        subcategories: _selectedSubCategories.join(",").toString(),
        sole: _selectedSoleCategories.join(",").toString(),
        color: _selectedColorCategories.join(",").toString(),
        seller: _selectedSellerCategories.join(",").toString(),
        gender: _selectedGenderCategories.join(",").toString(),
            ...
            child: Container(
              decoration: BoxDecoration(
                  ...
                  border: Border.symmetric(
                      vertical: BorderSide(color: MyTheme.grey_153, width: 1),
                      horizontal:
                    ...
                    textFieldConfiguration: TextFieldConfiguration(
                      ...
                      decoration: InputDecoration(
                          ...
                          enabledBorder: OutlineInputBorder(
                            borderSide:
                                BorderSide(color: MyTheme.white, width: 1.0),
                          ),
