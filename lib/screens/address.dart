                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Text("${AppLocalizations.of(context)!.address_ucf}",
                                style: TextStyle(
                                    color: MyTheme.dark_font_grey,
                                    fontSize: 12)),
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Text("${AppLocalizations.of(context)!.country_ucf}",
                                style: TextStyle(
                                    color: MyTheme.dark_font_grey,
                                    fontSize: 12)),
                            Padding(padding: EdgeInsets.only(left: 5.0)),
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Text("${AppLocalizations.of(context)!.state_ucf}",
                                style: TextStyle(
                                    color: MyTheme.dark_font_grey,
                                    fontSize: 12)),
                            Padding(padding: EdgeInsets.only(left: 5.0)),
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Text("${AppLocalizations.of(context)!.city_ucf}",
                                style: TextStyle(
                                    color: MyTheme.dark_font_grey,
                                    fontSize: 12)),
                            Padding(padding: EdgeInsets.only(left: 5.0)),
