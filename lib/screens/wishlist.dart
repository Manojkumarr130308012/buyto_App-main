...
import '../ui_elements/wishlist_card.dart';
        ...
        child: MasonryGridView.count(
          ...
          itemBuilder: (context, index) {
            ...
            return WishlistCard(
              ...
              category_name: _wishlistItems[index].product.new_category_name,
              brand_name: _wishlistItems[index].product.new_brand_name,
              margin: _wishlistItems[index].product.margin.toString(),
              mrp: _wishlistItems[index].product.mrp,
              moq: _wishlistItems[index].product.min_order_qty,
              unit_name: _wishlistItems[index].product.unit_name,
              gender: _wishlistItems[index].product.gender,
