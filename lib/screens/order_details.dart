  ...
  onPressOfflinePaymentButton() {
    Navigator.push(context, MaterialPageRoute(builder: (context) {
      return Checkout(
        ...
        rechargeAmount: double.parse(_orderDetails!.subtotal.toString()),
      );
    })).then((value) {
      onPopped(value);
    });
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      if (_orderDetails!.delivery_status == "Delivered")
                        Btn.basic(
                          minWidth: 60,
                          // color: MyTheme.font_grey,
                          onPressed: () {
                      ...
                      if (_orderDetails!.delivery_status != "cancelled")
                        Btn.basic(
                          // shape: RoundedRectangleBorder(side: Border()),
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(
                                  " Cancel Order",
                                  style: TextStyle(
                                      color: MyTheme.brick_red, fontSize: 14),
                                ),
                              ],
                            ),
                          ),
              ...
              children: [
                Padding(
                  ...
                  child: FadeInImage.assetNetwork(
                    ...
                    image: _orderedItemList[index].thumbnail_image,
                    width: 40,
                    height: 40,
                    fit: BoxFit.cover,
                  ),
                ...
                Padding(
                  padding: const EdgeInsets.only(bottom: 8.0),
                  child: Text(
                    "Product Name : ${_orderedItemList[index].product_name}",
                    maxLines: 2,
                    style: TextStyle(
                      color: MyTheme.font_grey,
                    ),
            ...
            Row(
              ...
              children: [
                Padding(
                  padding: const EdgeInsets.only(bottom: 8.0),
                  child: Text(
                    "Color : ${_orderedItemList[index].color}",
                    maxLines: 2,
                    style: TextStyle(
                      color: MyTheme.font_grey,
                    ),
                ...
                Padding(
                  padding: const EdgeInsets.only(bottom: 8.0),
                  child: Text(
                    "GST(${_orderedItemList[index].tax_rate.replaceAll(SystemConfig.systemCurrency!.code!, SystemConfig.systemCurrency!.symbol!)}) : ${_orderedItemList[index].tax.replaceAll(SystemConfig.systemCurrency!.code!, SystemConfig.systemCurrency!.symbol!)}",
                    maxLines: 2,
                    style: TextStyle(
                      color: MyTheme.font_grey,
                    ),
