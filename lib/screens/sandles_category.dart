...
class SandlesCategory extends StatefulWidget {
  int? sandleId;
  SandlesCategory({Key? key, this.sandleId}) : super(key: key);

  @override
  State<SandlesCategory> createState() => _SandlesCategoryState();
}

class _SandlesCategoryState extends State<SandlesCategory> {
  ...
  Future fetchPriceCategoryData() async {
    var ProductCategoryResponse =
        await ProductRepository().getSandleCategory(id: widget.sandleId);
