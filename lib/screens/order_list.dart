              ...
              child: Row(
                children: [
                  Text(_orderList[index].date,
                      style: TextStyle(
                          color: MyTheme.dark_font_grey, fontSize: 14, fontFamily: 'NotoSans')),
                  Spacer(),
                  Text(
              ...
              child: Row(
                children: [
                  Text(
                    ...
                    style:
                        TextStyle(color: MyTheme.dark_font_grey, fontSize: 14, fontFamily: 'NotoSans'),
                  ),
                  Text(
            ...
            Row(
              children: [
                Text(
                  ...
                  style: TextStyle(color: MyTheme.dark_font_grey, fontSize: 14, fontFamily: 'NotoSans'),
                ),
                Text(
