...
import 'package:active_ecommerce_flutter/screens/raise_tickets.dart';
import 'package:active_ecommerce_flutter/screens/refund_request.dart';
import 'package:active_ecommerce_flutter/screens/top_selling_products.dart';
import 'package:active_ecommerce_flutter/screens/wallet.dart';
import 'package:active_ecommerce_flutter/screens/wishlist.dart';
import 'package:active_ecommerce_flutter/screens/seller_verify.dart';
...
bool _isLoading=false;
  ...
  fetchCustomerInfo() async {
    setState(() {
     ...
     userInfoResponse =
        await ProfileRepository().getUserInfoResponse();
    ...
    _profileCodLimit = userInfoResponse?.data?[0].codlimit.toString();
    _profileVerification =
        userInfoResponse?.data?[0].buyer_verfication.toString();
    setState(() {
      _isLoading = false;
    });
  }
        ...
        children: [
          ...
          if (is_logged_in.$ && (vendor_system.$))
            Column(
              children: [
                buildBottomVerticalCardListItem(
                    "assets/shop.png", 'Raise Tickets', onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) {
                    return Raise_Tickets();
                  }));
                }),
                Divider(
                  thickness: 1,
