...
class ProductCategoryById extends StatefulWidget {
  ProductCategoryById(
      {Key? key,
      this.category_name,
      this.category_id,
  ...
  @override
  _ProductCategoryByIdState createState() => _ProductCategoryByIdState();
}
...
class _ProductCategoryByIdState extends State<ProductCategoryById> {
  ...
  fetchData() async {
    var productResponse = await ProductRepository().getCategoryProductsById(
