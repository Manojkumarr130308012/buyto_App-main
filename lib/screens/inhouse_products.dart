          ...
          child: MasonryGridView.count(
            ...
            itemBuilder: (context, index) {
              return ProductCard(
                ...
                category_name: _inhouseProductList[index].new_category_name,
                brand_name: _inhouseProductList[index].new_brand_name,
                margin: _inhouseProductList[index].margin,
                mrp: _inhouseProductList[index].mrp,
                moq: _inhouseProductList[index].moq,
                unit_name: _inhouseProductList[index].unit_name,
                gender: _inhouseProductList[index].gender,
