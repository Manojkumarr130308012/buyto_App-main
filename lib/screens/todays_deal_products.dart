              ...
              child: MasonryGridView.count(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ProductCard(
                    ...
                    margin: productResponse.products![index].margin,
                    mrp: productResponse.products![index].mrp,
                    moq: productResponse.products![index].moq,
                    unit_name: productResponse.products![index].unit_name,
                    brand_name: productResponse.products![index].new_brand_name,
                    category_name: productResponse.products![index].new_category_name,
                    gender: productResponse.products![index].gender,
                  );
                },
              ),
            );
