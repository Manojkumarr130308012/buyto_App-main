...
class SellerFromMarket extends StatefulWidget {
  int? sellerId;
  SellerFromMarket({Key? key, this.sellerId}) : super(key: key);

  @override
  State<SellerFromMarket> createState() => _SellerFromMarketState();
}

class _SellerFromMarketState extends State<SellerFromMarket> {
  var sellerMarketList = [];
  ...
  Future fetchSellerData() async {
    var sellerMarketResponse = await ProductRepository()
        .getSellerFromMarket(id: widget.sellerId, page: _page);

    setState(() {
      _productList.addAll(sellerMarketResponse.products!);
    });
