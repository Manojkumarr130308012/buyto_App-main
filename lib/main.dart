...
import 'screens/seller_verify.dart';
        ...
        child: Consumer<LocaleProvider>(builder: (context, provider, snapshot) {
          return MaterialApp(
            ...
            routes: {
              ...
              "/seller_verify": (context) => SellerVerify(),
              "/all_products": (context) => AllProducts(),
              // "/seller_from_market": (context) => SellerFromMarket(),
              // "/product_category": (context) => PriceCategory(),
              // "/sandles_category": (context) => SandlesCategory(),
            },
