...
final SharedValue<bool> otp_logged_in = SharedValue(
  value: false, // initial value
  key: "is_otp_in", // disk storage key for shared_preferences
);
...
final SharedValue<bool> name = SharedValue(
  value: false, // initial value
  key: "name", // disk storage key for shared_preferences
);

final SharedValue<bool> phone = SharedValue(
  value: false, // initial value
  key: "phone", // disk storage key for shared_preferences
);
