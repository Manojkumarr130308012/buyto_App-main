...
class MyTheme {
  ...
  static const Color accent_color = Color.fromRGBO(2, 96, 160, 1);
  ...
  //     2, 96, 160, 1); // if not sure , use the same color as accent color
  static Color splash_screen_color = Color.fromRGBO(
      255, 255, 255, 1.0);
  ...
  static Color buyto_orange = Color.fromRGBO(126, 81,9, 0);
  //testing shimmer
